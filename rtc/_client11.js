...
function getAllUsersFunction() {
    ...
    $.get('https://webtel.dev.jacos.jp:3000/get_all_users/' + myID, {}, function (data) {
...
function reloadSocketConnection() {
    ...
    conn.onmessage = function (msg) {
        console.log("receiving data", msg.data);
...
function logInUser() {
    ...
    console.log(nameeadee, 'nameeadee')
